...
visual = f'''<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="675" viewBox="0 0 1200 675"><defs><linearGradient id="g" x1="0" x2="1"><stop stop-color="#6d2b21"/><stop offset="1" stop-color="#c8a45d"/></linearGradient></defs><rect width="1200" height="675" fill="#160d07"/><g opacity=".25" stroke="#6d2b21">{''.join(f'<line x1="{x}" y1="0" x2="{x-220}" y2="675"/>' for x in range(0,1500,70))}</g><text x="70" y="130" fill="#fff" font-size="54" font-family="Arial" font-weight="800">Netflix Content Strategy Analytics</text><text x="70" y="190" fill="#b9a98d" font-size="26" font-family="Arial">Old-Money executive dashboard • engagement • churn • revenue • recommendations</text><rect x="70" y="260" width="250" height="140" rx="24" fill="#3a2415" stroke="#6d2b21"/><text x="95" y="315" fill="#b9a98d" font-size="20" font-family="Arial">Watch Sessions</text><text x="95" y="370" fill="#c8a45d" font-size="44" font-family="Arial" font-weight="800">{n_sessions:,}</text><rect x="350" y="260" width="250" height="140" rx="24" fill="#3a2415" stroke="#c8a45d"/><text x="375" y="315" fill="#b9a98d" font-size="20" font-family="Arial">Users</text><text x="375" y="370" fill="#6d2b21" font-size="44" font-family="Arial" font-weight="800">{n_users:,}</text><rect x="630" y="260" width="250" height="140" rx="24" fill="#3a2415" stroke="#6d2b21"/><text x="655" y="315" fill="#b9a98d" font-size="20" font-family="Arial">Churn AUC</text><text x="655" y="370" fill="#1f4d36" font-size="44" font-family="Arial" font-weight="800">{metrics['roc_auc']:.2f}</text><rect x="910" y="260" width="220" height="140" rx="24" fill="#3a2415" stroke="#c8a45d"/><text x="935" y="315" fill="#b9a98d" font-size="20" font-family="Arial">Titles</text><text x="935" y="370" fill="#fff" font-size="44" font-family="Arial" font-weight="800">{n_content:,}</text><path d="M90 550 C260 460 370 565 520 480 S805 535 1030 430" fill="none" stroke="url(#g)" stroke-width="10" stroke-linecap="round"/></svg>'''
